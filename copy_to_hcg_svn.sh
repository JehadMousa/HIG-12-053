...
cp -L -r -v limits/vhtt/common hcg/couplings/vhtt/

echo "Copying 2nd Higgs search cards"
cat searches_masses.txt | xargs -n 1 -I {} cp -L -r -v limits_2ndhiggs/vhtt/{} hcg/searches/vhtt/
cp -L -r -v limits_2ndhiggs/vhtt/common hcg/searches/vhtt/
